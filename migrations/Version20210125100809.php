 ...
 */
final class Version20210125100809 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD picture_id INT DEFAULT NULL, ADD username VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP picture_id, DROP username');
    }
}
